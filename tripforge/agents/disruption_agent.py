...
def get_disruption_agent(model_name: str = "gemini-2.5-flash", tools: List[Any] = None) -> Agent:
    ...
    instruction = (
        ...
        "10. You must generate detailed sections and schedule slots for EVERY single day requested in the duration. Never truncate the response, never use placeholders like '(Days 4-7 follow similar rhythms...)', and never skip details or entries for any day.\n\n"
