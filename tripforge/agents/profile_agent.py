...
def get_profile_agent(model_name: str = "gemini-2.5-flash") -> Agent:
    ...
    instruction = (
        ...
        "- destination: Validate and clean the destination name. You support planning for any city, region, state, or country in the world (e.g., Paris, Tokyo, Kedah, Pulau Pinang, Malaysia, etc.). Clean and format it to standard title casing (e.g. 'Pulau Pinang, Malaysia').\n"
